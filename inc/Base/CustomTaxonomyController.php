...
class CustomTaxonomyController extends BaseController
{
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'awesome_plugin_tax_settings',
				'option_name' => 'awesome_plugin_tax',
	...
	{
		$options = get_option( 'awesome_plugin_tax' ) ?: array();
